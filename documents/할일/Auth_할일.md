...
- [x] Step 1: 기본 인프라 및 공통 설정
- [x] Step 2: 도메인 모델 생성
- [x] Step 3: 도메인 레포지토리 인터페이스 생성
- [x] Step 4: 이메일 인증 기능 구현
- [x] Step 5: 일반 회원가입 구현 (FR-001)
- [x] Step 6: 일반 로그인 구현 (FR-002)
- [x] Step 7: 로그아웃 구현 (FR-004)
- [x] Step 8: 소셜 로그인 구현 (FR-003)
  - [x] 8-1. 카카오 로그인 config 설정 등록
- [x] Step 9: 비밀번호 찾기 구현
